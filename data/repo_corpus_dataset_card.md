...
hf upload solanaclawd/solana-clawd-repo-corpus data/core_ai_dataset_manifest.json metadata/core_ai_dataset_manifest.json --repo-type dataset --commit-message "Add build manifest"
```
...
the same config or override `--dataset-repo solanaclawd/solana-clawd-repo-corpus`.
